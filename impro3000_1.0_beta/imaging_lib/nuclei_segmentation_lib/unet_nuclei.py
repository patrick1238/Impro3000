...
class myUnet(object):
	...
	def train(self):
		...
		model_checkpoint = ModelCheckpoint('./unet_nuclei_weights.hdf5', monitor='loss',verbose=1, save_best_only=True)
		print('Fitting model...')
	...
	def save_img(self):
		...
		imgs = np.load('results/imgs_mask_test_evaluation.npy')
